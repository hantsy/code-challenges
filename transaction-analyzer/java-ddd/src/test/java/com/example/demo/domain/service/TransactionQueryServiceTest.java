...
class TransactionQueryServiceTest {
    ...
    private final CollectingNotifier notifier = new CollectingNotifier();
    private final TransactionQueryService service = new TransactionQueryService(store, List.of(notifier));
